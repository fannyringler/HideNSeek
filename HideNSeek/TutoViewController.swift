...
class TutoViewController: UIViewController {
    ...
    var imageToShow = 1
    var textToShow : [String] = ["Choisissez le nombre de personnes qui vont chercher le ou les objet(s)","Vous pouvez donner un nom à chaque chercheur","Cliquez sur \"Suivant\" pour valider","Choisissez le nombre d'objets à cacher","Lorsque qu'un carré partiel apparait, vous pouvez déposer un objet dessus","Si le carré est entier, la zone est optimale","Choisissez le modèle de ce que vous voulez cacher","Cliquez sur l'écran pour ajouter un objet, soyez prêt du carré pour un rendu optimal\n Appuyez sur \"Cache\" pour valider","Donner le jeu au joueur indiqué\n Le joueur devra appuyer sur \"C'est parti !\" pour jouer","Déplacez vous pour trouver les objets cachés","Cliquez sur l'objet pour signaler que vous l'avez trouvé","Quand tous les joueurs ont fini de trouver tous les objets, le classement s'affiche !"]
    ...
    override func viewDidLoad() {
        ...
        text.text = "Choisissez le nombre de personnes qui vont chercher le ou les objet(s)"
